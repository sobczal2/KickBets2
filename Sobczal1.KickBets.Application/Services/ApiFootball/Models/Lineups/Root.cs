...
public class Root
{
    ...
    [JsonPropertyName("startXI")] public List<PlayerWrapper> StartXI { get; set; } = null!;

    [JsonPropertyName("substitutes")] public List<PlayerWrapper> Substitutes { get; set; } = null!;

    [JsonPropertyName("coach")] public Coach Coach { get; set; } = null!;
}