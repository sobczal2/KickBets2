...
public class FootballApiService
{
    ...
    private async Task FixFixtureOnInsert(Fixture fixture)
    {
        if (fixture.VenueId.HasValue)
        {
            if(!await _unitOfWork.VenueRepository.Exists(fixture.VenueId.Value))
                await UpdateVenue(fixture.VenueId.Value);
        }
    ...
    {
        var client = new RestClient($"https://api-football-v1.p.rapidapi.com/v3/leagues?id={leagueId}&current=true");
        var request = new RestRequest();
        request.AddHeader("X-RapidAPI-Host", "api-football-v1.p.rapidapi.com");
        request.AddHeader("X-RapidAPI-Key", _configuration["ApiFootball:Key"]);
    ...
    {
        var client = new RestClient($"https://api-football-v1.p.rapidapi.com/v3/fixtures/lineups?fixture={fixtureId}");
        var request = new RestRequest();
        request.AddHeader("X-RapidAPI-Host", "api-football-v1.p.rapidapi.com");
        request.AddHeader("X-RapidAPI-Key", _configuration["ApiFootball:Key"]);
    ...
    {
        var client = new RestClient($"https://api-football-v1.p.rapidapi.com/v3/fixtures/events?fixture={fixtureId}");
        var request = new RestRequest();
        request.AddHeader("X-RapidAPI-Host", "api-football-v1.p.rapidapi.com");
        request.AddHeader("X-RapidAPI-Key", _configuration["ApiFootball:Key"]);
