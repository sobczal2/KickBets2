    ...
    return (
        ...
        >
            ...
            >
                ...
                >Bet: Score at half time</DialogTitle>
                <DialogContent
                >
                    <Box
                    ...
                    <Grid item xs={4}>
                        <Box sx={fixtureDetailsBetsSectionDisplayInnerBoxStyle}>
                            ...
                            <Typography
                                sx={fixtureDetailsBetsSectionDisplayMultiplierStyle}
                            >
                                {wdlhtData?.drawBetsMultiplier ? `x${wdlhtData?.drawBetsMultiplier.toFixed(2)}` : "unknown"}
                            </Typography>
                        </Box>
                    </Grid>
                    <Grid item xs={4}>
                        <Box sx={{...fixtureDetailsBetsSectionDisplayInnerBoxStyle, border: "none"}}>
                            ...
                            <Typography
                                sx={fixtureDetailsBetsSectionDisplayMultiplierStyle}
                            >
                                {wdlhtData?.awayBetsMultiplier ? `x${wdlhtData?.awayBetsMultiplier.toFixed(2)}` : "unknown"}
                            </Typography>
                        </Box>
                    </Grid>
                </Grid>
